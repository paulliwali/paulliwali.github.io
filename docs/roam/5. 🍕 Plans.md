...
1. Physical: learn a new skill every month - [[2024 Physical Goal Progression]]
  - [ ] January: 2 minute dead hang
  - [x] February: 30 seconds L sit
  ...
  - [ ] November: handstand
  - [ ] December: planche
2. Personal learning: finished the Coursera ML courses - [[Coursera - Machine Learning Specialization]] and [[Deep Learning Specialization]]
3. Programming: finished 3 side projects
  - [[3 ways to regret ff]]
  - [[IG account of super obvious charts]]
  - [[aaronson-oracle-baseball]]
4. Relationship: work on a physical goal together, have a strong foundation of day to day life, go on fun dates, ask to learn a skill together
5. Mishogi
  - [[SF Marathon 2024]]
...
- [x] Established a good routine with Hanh on the weekdays
  - [x] Assist with finance
  - [x] Cooking together
  - [x] Gym together
  - [ ] Find a hobby that can be maintained
  - [x] Finding furnitures and moved in
  - ==[0.8]==
...
- [ ] [[2024 Physical Goal Progression]]
	...
	- [ ] 50 pull ups
		- ==[0] Did not do==
- [x] Ramp up Marathon Training by getting more weekly volume
...
- [ ] Progress 50% in [[Coursera - Machine Learning Specialization]]
	- ==[0.5] Did some work==
- [x] Finish [[Crying in H Mart]]
- [x] Finish [[Misbelief]]
- [x] Finish [[A Prayer for the Crown-Shy]]
- [x] Plan hikes
	- Trans Catalina?
...
## Q3
- [x] [[SF Marathon 2024]]
- [x] Planning and traveling with Aaron and Hanh [[China-Korea Trip 2024]]
...
- [x] Finish [[aaronson-oracle-baseball]] with ChatGPT and create a website
...
- [x] Start a hikes bucket list [[Hikes Bucket List]]
...
- Read a ton of interesting book and having the [[8. ☕️ Finer Things Book Club]] really kept me on track when I didn't feel like reading. I think I ended with 9 books read this year but should be able to push to 10 before the very end. See the books here - [[2. 📚 Books to Read]].
