...
This year it seems I had a bigger tech focus and didn't do the best job at capturing the daily fun tidbits of learning.

<!--truncate-->

When every line of code I write (ahem generate ahem) these days has been checked by a LLM, I can't lie and say this year's TIL has also been grammatically and fact checked. If there still is an issue, take it up with Claude (see Fact 22).

1. SLC
   * An acronym for simple, lovable and complete
...
2. Tog's Paradox
    ...
    * Named after Bruce Tognazzini

3. Rubbing mud
    * MLB doesn't use brand new baseballs, they prep the ball with mud to remove the sheen on the leather
    * A special variety of muck was discovered by Lena Blackburne in Burlington County along the Delaware river was used to prep the balls that had enough texture and didn't turn the balls black. It has been used since 1938 (over 85 years)
...
6. Those dots on the car glass
   * They are called "frits" and they are ceramic-based enamel baked into the glass during manufacturing to help with temperature gradient ([see what they look like](https://www.thedrive.com/wp-content/uploads/2023/02/03/20230203-Windshield-Frit.jpg))
...
9. Woodpecker's Tongue
    * Wraps around its head, though recent research debates whether this anatomical feature actually provides shock absorption or if protection comes from the bird's small brain size ([see the anatomy](https://abcbirds.org/wp-content/uploads/2025/03/Woodpecker-Tongue-Diagram-by-Denise-Takahashi-1.png))
    * Reminds me of those neck braces football players wear for concussion protection

10. Fermi estimation
    * Back of envelope type problems that require the person to use common sense, order of magnitude and good assumptions to come up with the rough answer  

11. Skulduggery
    * A new word that I learned, it means underhanded or unscrupulous behavior

12. Rolex
    * Name changed from Wilsdorf & Davis in 1915 during WW I due to anti-German sentiments
    * Moved to Geneva, Switzerland in 1919 partially due to post-war taxes in UK and also being closer to the movement manufacturing
...
13. Why are there so many Swiss based watch makers?
    * There is a Swiss manufacturing system called "Établissage" where a complex system is broken into individual components and an independent specialists focuses on that component only, then assembled into finished watches by a separate entity
    * Geneva was also the center of activity for the Protestant Christians led by John Calvin, who was focused on moral uprightness and they don't have things like ornamental jewelry so the workshops are focused on watchmaking because it serves a functional purpose

14. Cod
    * Large, edible sea fish, particularly those from the genus Gadus
    * The word origin is unclear, though one theory suggests it may relate to the "cod end" (bag-like end) of fishing nets where this bottom-dwelling fish was often found
...
16. Auction types
    * English auctions: prices keep rising until a single highest bidder wins
...
18. Stoops
    * Stair entries to houses, common in New York, Boston, Philly, built to avoid horse manure ([classic NYC stoops](https://ephemeralnewyork.wordpress.com/2020/12/07/how-new-york-became-a-metropolis-of-stoops/))
    ...
    * Dutch settlers brought this influence to Northeastern US when they colonized it
...
19. Does reading or playing video games lead to near-sightedness?
    ...
    * Recent studies have shown correlation between lack of outdoor play and natural light exposure with increased risk of myopia as an adult ([source](<https://pmc.ncbi.nlm.nih.gov/articles/PMC7973740/>))
...
21. Markov Chains
    ...
    * Andrey Markov (socialist, atheist) and Pavel Nekrasov (tsar, religious) argued whether mathematics can explain will of god and free will
       ...
       * Used a poem to train a text prediction model and found that the probability of two letters that occurred is different than their expected average *assuming independence*
       * Built a model to make this dependent event prediction which is the *Markov Chain* and showed that it can *follow the LLN as well*
...
22. Claude Shannon
    ...
    * Designed and built a learning machine called Theseus. Which is a maze with a mechanical mouse that learns how to search for a target using the shortest path ([see Theseus at MIT Museum](https://mitmuseum.mit.edu/collections/object/2007.030.001))
...
23. Resume driven development
    ...
    * Sometimes I see this in resume screenings and not something I agree with, I subscribe to the idea behind the quote * "ideas should be so simple that people are upset that they didn't come up with it"
...
25. 6-7
    ...
    * The original meaning from the Skrilla song is intentionally ambiguous - one theory suggests it refers to a police radio code for a dead body
...
27. Manufacturing tanks in peace times
    * The concept that it is important to maintain some level of production capacity for critical industries during peacetime to preserve institutional knowledge and prevent the loss of specialized manufacturing capabilities

28. Ortega Hypothesis vs Newton Hypothesis
    * Ortega hypothesis is that the bulk of science advancements made by average scientists over time/volume
...
30. Hypocenter vs epicenter
    ...
    * Epicenter is the above ground point where the earthquake happened ([see the diagram](https://redsismica.uprm.edu/english/education/imgs/earthquakes/hypocenter.png))
